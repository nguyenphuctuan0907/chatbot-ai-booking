...
// Mỗi node trả về type này thay vì mutate session trực tiếp
export type NodeResult = Partial<KaraokeSessionState>;

// Action type để respond node biết phải reply gì
